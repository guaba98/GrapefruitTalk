...
class Members:
    def __init__(self, user_nums:int):
        self.user_num = user_nums

# 친구 초대 요청
class ReqSuggetsFriend:
    def __init__(self, myAddr: tuple, otherAddr: tuple): #myAddr : 초대요청자 소켓주소, otherAddr : 초대수락자 소켓주소 -> 9. 예) 상대방 회원아이디
        self.myAddr = myAddr
